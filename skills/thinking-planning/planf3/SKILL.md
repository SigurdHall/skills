...
| Adversarial Review | Invoked by Create Plan and Update Plan after the plan is saved; an independent Codex model attacks the plan before it is considered done | `workflows/adversarial-review.md` |
