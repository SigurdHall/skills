...
9. Adversarial Review - Run the sub-workflow in `workflows/adversarial-review.md`; the plan is not done until the review findings are triaged and applied
10. Open in Browser - Open the saved plan in `BROWSER` (e.g. `open -a "Google Chrome" PLAN_FILE`)
