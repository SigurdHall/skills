...
6. Adversarial Review - Run the sub-workflow in `workflows/adversarial-review.md`; skip only for pure metadata or typo edits that change no decision
7. Report - Summarize the change made, the amendment recorded, and the review outcome
